...
Table `booking_refunds` — migration `20260907120000-create-booking-refunds.js` (idempotent create via `tableExists`). Deploy path already runs `ensure-live-migrations.js`.
